...
针对的 Hayagriva 版本：[2026-06-05 `v0.10.0`](https://github.com/typst/hayagriva/releases/tag/v0.10.0)，对应 Typst v0.15.0-rc.1。
...
然而 **[Hayagriva 提供的错误信息不是特别清晰](https://github.com/typst/hayagriva/issues/405)**，调试比较困难。即使您[理解 Hayagriva 报了什么错](https://typst-doc-cn.github.io/guide/FAQ/bib-csl.html)，通常也需逐一修改，反复重新编译，才能解决问题。
